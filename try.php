...
<div class="mb-3">
    ...
    <input type="tel" class="form-control" id="phoneNumber" name="phoneNumber" placeholder="Entrez votre numéro de téléphone">
</div>
            <div class="row">
...
<div class="row">
    ...
    <div class="col-md-4 mb-3">
        <div class="input-group">
            <input type="password" class="form-control" id="oldPassword" name="oldPassword" placeholder="Ancien mot de passe" value="">
